...
public class PlaybackEventCoordinatorTests
{
    ...
    private sealed class BlockingWorker : IPlaybackAnalysisWorker
    {
        ...
        public async Task RunAsync(PlaybackWorkerRequest request, FanOutFrameBuffer<AnalysisFrame> latestFrames, Action<double?> reportSourceFramesPerSecond, CancellationToken cancellationToken)
        {
